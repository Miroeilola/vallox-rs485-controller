...
export const KEYS = { ArrowLeft: 0, ArrowRight: 1, Enter: 2, Backspace: 3 };   // − + OK ←
...
export class Loop {
  ...
  press(idx) { this._pressed.add(idx); this.sim.button(idx, 1); for (const fn of this.onButton) fn(idx, true); }
  release(idx) { this._pressed.delete(idx); this.sim.button(idx, 0); for (const fn of this.onButton) fn(idx, false); }
